                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1" id="posteContenant">
					...
					<div class="row control-group">
                        <div class="form-group col-xs-12 floating-label-form-group controls">
                            <label>Titre</label>
                            <input type="text" name="titreBlog" class="form-control" placeholder="Title" id="titleBlog" required data-validation-required-message="Please enter a title.">
                    ...
                    <div class="row control-group">
                        <div class="form-group col-xs-12 floating-label-form-group controls">
                            ...
                            <input type="text" name="sousTitreBlog" class="form-control" placeholder="Subtitle (short explanation in one sentence)" id="subtitleBlog" required data-validation-required-message="Please enter a short description of your post.">
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>                  
                 	<div class="row control-group">
                        <div class="form-group col-xs-12 floating-label-form-group controls">
                            <label>Texte</label>
                            <textarea rows="20" style="width:100%" name="texte" placeholder='Entrez le texte ici'></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    <div class="row control-group">
